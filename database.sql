...
VALUES
    ('John', 'Doe', 'johnd', 'john.doe@example.com', '$2y$10$tg7YNx/KbDT5YUkc91GhaOJs2e2pyoafY6b/N5/4exVV8lw7rYxBi', 'registered_user'),
    ('Jane', 'Smith', 'janes', 'jane.smith@example.com', '$2y$10$K0MYzXyjpJS2kZxk5sRr6h8JKd68J/ZZYyFieExhjbfVyi/N3j9Ab', 'registered_user'),
    ('Alice', 'Johnson', 'alicej', 'alice.johnson@example.com', '$2y$10$tg7YNx/KbDT5YUkc91GhaOJs2e2pyoafY6b/N5/4exVV8lw7rYxBi', 'admin');